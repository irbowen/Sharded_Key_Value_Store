...
./paxos_server --port 8000 --host 127.0.0.1 --config config5.txt --id 0 &
./paxos_server --port 8001 --host 127.0.0.1 --config config5.txt --id 1 &
./paxos_server --port 8002 --host 127.0.0.1 --config config5.txt --id 2 &
./paxos_server --port 8003 --host 127.0.0.1 --config config5.txt --id 3 &
./paxos_server --port 8004 --host 127.0.0.1 --config config5.txt --id 4 &
